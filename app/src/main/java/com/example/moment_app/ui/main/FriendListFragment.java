...
public class FriendListFragment extends Fragment {
    ...
    private Button buttonBackListFr;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewListFriend = view.findViewById(R.id.recyclerViewListFr);
        recyclerViewListFriend.setLayoutManager(new LinearLayoutManager(getContext()));
        buttonBackListFr = view.findViewById(R.id.buttonBackListFr);

        buttonBackListFr.setOnClickListener(v -> {
        ...
        accountRepository.getFriends(request, new AccountRepository.SearchFriendCallback() {
            @Override
            public void onSuccess(ApiResponse<List<AccountResponse>> response) {
                requireActivity().runOnUiThread(() -> {
                    ...
                    if (response.getStatus() == 200) {
                        ...
                        recyclerViewListFriend.setAdapter(adapter);
                    } else {
        ...
        recyclerViewListFriend.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
