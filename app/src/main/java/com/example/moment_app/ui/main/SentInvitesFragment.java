 ...
 * Use the {@link SentInvitesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SentInvitesFragment extends Fragment {
    private Button buttonBackSent;
     ...
     * @return A new instance of fragment SentInvitesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SentInvitesFragment newInstance(String param1, String param2) {
        SentInvitesFragment fragment = new SentInvitesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sent_invites, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonBackSent = view.findViewById(R.id.buttonBackSent);


        recyclerViewSent = view.findViewById(R.id.recyclerViewSent);
        recyclerViewSent.setLayoutManager(new LinearLayoutManager(getContext()));

        buttonBackSent.setOnClickListener(v -> {
        ...
        accountRepository.getFriendsSent(request, new AccountRepository.SearchFriendCallback() {
            @Override
        ...
        recyclerViewSent.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
