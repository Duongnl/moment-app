 ...
 * Use the {@link ReceivedInvitesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReceivedInvitesFragment extends Fragment {

    private Button buttonBackReceived;
    ...
    public ReceivedInvitesFragment() {
     ...
     * @return A new instance of fragment ReceivedInvitesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ReceivedInvitesFragment newInstance(String param1, String param2) {
        ReceivedInvitesFragment fragment = new ReceivedInvitesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_received_invites, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonBackReceived = view.findViewById(R.id.buttonBackReceived);


        recyclerViewReceived = view.findViewById(R.id.recyclerViewReceived);
        recyclerViewReceived.setLayoutManager(new LinearLayoutManager(getContext()));

        buttonBackReceived.setOnClickListener(v -> {
            Fragment friend = new FriendFragment(); // fragment bạn muốn mở

            requireActivity()
                    .getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.fragmentContainerMain, friend) // ID của container chứa Fragment
            ...
            public void onSuccess(ApiResponse<List<AccountResponse>> response) {
                requireActivity().runOnUiThread(() -> {
                    ...
                    if (response.getStatus() == 200) {
                        ...
                        recyclerViewReceived.setAdapter(adapter);
                    } else {
        ...
        recyclerViewReceived.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    private void loadMoreData() {
        ...
        FriendFilterRequest request = new FriendFilterRequest(currentPage, currentTimeISO8601);
